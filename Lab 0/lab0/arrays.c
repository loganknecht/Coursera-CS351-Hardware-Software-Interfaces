...
// TODO: Research
// Can also be declared like this, but it will fail because... I don't know?
// struct FourInts {
//   int a, b, c, d;
// };
...
int main(int argc, char* argv[]) {
  ...
  // testing.
  // Answer:
  // 10 - works - This is probably accessing garbage data.
  // 100 - works - This is probably accessing garbage data.
  // 1000 - segmentation fault - This is because we're likely accessing memory outside of the array declaration on the stack?
  fillArray(array, 10);
  ...
  // Answer: This is because in C arrays are actually pointers to a primitive
  //         data types and these are the equivilant to a primitive data type
  //         declaration.
  fillArray(&value, 1);
  ...
  // C++ programming.
  // Answer: 20 bytes of memory of leaked in one block
  free(heap_array);
  ...
  // You can do assignments of structs to another and that will take the values
  // of the assigned struct.
  // FourInts test_four_ints;
  // test_four_ints.a = 22;
  // FourInts t = test_four_ints;
  // FourInts t;
  // printf("%d", t.a);
  // printf(t)
